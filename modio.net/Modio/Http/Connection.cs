...
namespace Modio
{
    ...
    internal class Connection : IConnection
    {
        ...
        public Connection(Uri baseAddress, Credentials credentials, int timeoutInMins)
        {
            http = new HttpClient();
            http.Timeout = TimeSpan.FromMinutes(timeoutInMins);
        ...
        private HttpRequestMessage BuildRequest(Request request)
        {
            ...
            try
            {
                ...
                {
                    parameters["api_key"] = Credentials.ApiKey;
                }
