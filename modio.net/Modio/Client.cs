...
namespace Modio
{
    ...
    public partial class Client
    {
        ...
        /// </summary>
        public Client(Credentials credentials, int timeoutInMins) : this(new Connection(ModioApiUrl, credentials, timeoutInMins))
        {
        }
        ...
        /// </summary>
        public Client(Uri baseUrl, Credentials credentials, int timeoutInMins) : this(new Connection(FixBaseUrl(baseUrl), credentials, timeoutInMins))
        {
        }
